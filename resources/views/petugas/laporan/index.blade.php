                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-button-action justify-content-center d-flex">
                                        @if ($lap->status == '0')
                                            <a class="btn btn-success" type="button" href="{{ route('petugas.laporan.updateStatus', $lap->id) }}" onclick="return confirm('Apakah anda yakin ingin memproses laporan?')">
                                                <span class="btn-label">
                                                </span>
                                                Proses
                                            </a>
                                        @elseif($lap->status == 'proses')
                                            <a class="btn btn-warning" type="button" href="{{ route('petugas.laporan.updateStatus', $lap->id) }}" onclick="return confirm('Apakah anda yakin ingin menunda laporan?')">
                                                <span class="btn-label">
                                ...
                                <td>
                                    <div class="form-button-action justify-content-center d-flex">
                                        ...
                                        @else
                                            <a class="btn btn-info" type="button" href="{{ route('petugas.laporan.show', $lap->id) }}">
                                                <span class="btn-label">
                                                    <i class="fa fa-info"></i>
                                                </span>
                                                Detail
